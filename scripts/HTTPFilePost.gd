...
# Example usage:
#$GodotHTTPFilePost.post_file("https://api.convai.com/character/getResponse", "file", "audio.wav", "user://audio.wav", { "charID": "asdf", "sessionID": "-1", "responseLevel": "5", "voiceResponse": "True" }, "audio/wav")
